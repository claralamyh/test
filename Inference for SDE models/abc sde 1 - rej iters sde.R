...
set.seed(1126)
wrapper(
  abc <- abcrej.iters(N=170, epsilon=25, x0, par, T, deltat, it))
# Time difference of 4.566507 mins
...
# summaries
mean(out[,1]) #0.01781416
sd(out[,1]) #0.007367993
quantile(out[,1],c(0.025,0.975)) #0.006205526 0.034585987

mean(out[,2]) #3.018646
sd(out[,2]) #1.028345
quantile(out[,2],c(0.025,0.975)) #1.250785 5.417472
